<?php 
	...
	if($fetch->num_rows > 0){ //check username
		...
		$query = $mysqli->query("INSERT INTO tbl_users SET `user_fname` ='$user_fname', `user_mname`='$user_mname', `user_lname`='$user_lname', `username`='$username', password='$password', `user_category`='$user_category',`contact_number`='$contact_number',address='$address'");
