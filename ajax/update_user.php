<?php
	...
	if(isset($_POST['update_user_id'])){
		...
		if($fetch->num_rows > 0){ //check username
			...
			if($password_==""){
				$update_data = "user_category='$user_category', user_fname = '$user_fname', user_mname = '$user_mname', user_lname = '$user_lname', username = '$username', contact_number = '$contact_number', address = '$address'";
			}else{
				$password = md5($password_);
				$update_data = "user_category='$user_category', user_fname = '$user_fname', user_mname = '$user_mname', user_lname = '$user_lname', username = '$username', password = '$password', contact_number = '$contact_number', address = '$address'";
			}
